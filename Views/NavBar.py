...
"selection-color: rgb(170, 245, 255);")
        ...
        statusSelector = QtWidgets.QListWidgetItem()
        statusSelector.setForeground(QtGui.QColor(255, 255, 255))
        statusSelector.setFont(font)
        statusSelector.setText(_translate("MainWindow", "Job Status"))
        self.navbar.addItem(statusSelector)

        mtvSelector = QtWidgets.QListWidgetItem()
        mtvSelector.setForeground(QtGui.QColor(255, 255, 255))
        mtvSelector.setFont(font)
        mtvSelector.setText(_translate("MainWindow", "Meta Tree View"))
        self.navbar.addItem(mtvSelector)
        self.navbar.setCurrentItem(statusSelector)
